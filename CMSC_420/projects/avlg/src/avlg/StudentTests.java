...
public class StudentTests {
    ...
    @Test 
    public void testBasics1() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(3);
    	tree.insert(2);    	
    	tree.insert(1);
    	...
    	tree.insert(3);
    	tree.insert(4);
    	System.out.println("just testing basic count: " + tree.getCount());
    	System.out.println("is it a bst? " + tree.isBST());
    	System.out.println("is 5 in the tree? " + tree.search(5));
    	System.out.println("is tree balanced?" + tree.isAVLGBalanced());
    	System.out.println("longest path is " + tree.getHeight());
    }
    @Test 
    public void testBasics2() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(1);
    	tree.insert(2);
    	tree.insert(3);
    	...
    	System.out.println("is it a bst? " + tree.isBST());
    	System.out.println("is 5 in the tree? " + tree.search(5));
    	System.out.println("is 3 in the tree? " + tree.search(3));
    	System.out.println("is tree balanced?" + tree.isAVLGBalanced());
    	System.out.println("is tree a bst? " + tree.isBST());
    	System.out.println("root is " + tree.getRoot());
    }
    @Test 
    public void testBasics3() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(1);
    	tree.insert(3);
    	tree.insert(2);
    	...
    	System.out.println("is tree a bst? " + tree.isBST());
    	//System.out.println("root is " + tree.getRoot());
    	System.out.println("testing count " + tree.getCount());
    }
    @Test 
    public void testBasics4() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(4);
    	tree.insert(2);
    	tree.insert(3);
    ...
    @Test 
    public void testBasics5negatives() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(2);
    	tree.insert(0);
    	tree.insert(4);
    	...
    	System.out.println("root is " + tree.getRoot());
    	System.out.println("testing count " + tree.getCount());
    	System.out.println("deleting key " + tree.delete(2));
    	System.out.println("just testing basic count: " + tree.getCount());
    	System.out.println("root is " + tree.getRoot());
    }
    @Test 
    public void testPosNegatives() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(5);
    	tree.insert(-5);
    	tree.insert(10);
    	...
    	System.out.println("is tree balanced? " + tree.isAVLGBalanced());
    	System.out.println("is tree a bst? " + tree.isBST());
    	System.out.println("longest path size? " + tree.getHeight());
    	System.out.println("root is " + tree.getRoot());
    }
    @Test
    public void testDelete1() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(2);
    	tree.insert(1);
    	tree.insert(3);
