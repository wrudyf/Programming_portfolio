...
(provide Lit Prim0 Prim1 Prim2 Prim3 If Eof Begin Let
         Var Empty Prog Defn App
         Match Box Cons Conj Pred Apppat)  ;; NOTE: Updated.
;;
...
;;           | (Cons Pat Pat)
;;           | (Conj Pat Pat)
;;           | (Pred Id Pat)    ;; NOTE: New.
;;           | (Apppat Id Pat)  ;; NOTE: New.
...
(struct Pred (f p) #:prefab)
(struct Apppat (f p) #:prefab)
