...
(define ptr-mask       #b111)           ;;pointer mask
(define type-box       #b001)           ;;pointer 1 for box
(define type-cons      #b010)           ;;pointer 2 for cons
(define type-vect      #b011)           ;;pointer 3 for vector
(define type-str       #b100)           ;;pointer 4 for string
;;have 5 pointer vals so far, so we should have 2 ops left for val representation
(define type-values    #b101)           ;;pointer 5 for values
...
;;i think i will need a new type for values
